...
def test_analyze_index_page_success(tmp_path):
    ...
    from yoto_lib.lyrics_source_wizard import _analyze_index_page
    ...
    with patch("yoto_lib.lyrics_source_wizard.ClaudeProvider", mock_class):
...
def test_analyze_lyrics_page_success(tmp_path):
    ...
    from yoto_lib.lyrics_source_wizard import _analyze_lyrics_page
...
def test_run_wizard_success():
    ...
    with (
        patch("yoto_lib.lyrics_source_wizard.httpx.get", side_effect=fake_httpx_get),
        patch("yoto_lib.lyrics_source_wizard._analyze_index_page", return_value=index_analysis),
        patch("yoto_lib.lyrics_source_wizard._analyze_lyrics_page", return_value=lyrics_analysis),
        patch("yoto_lib.lyrics_source_wizard._run_js", side_effect=fake_run_js),
    ):
...
def test_run_wizard_fetch_error():
    ...
    with patch(
        "yoto_lib.lyrics_source_wizard.httpx.get",
...
def test_run_wizard_index_js_no_results():
    ...
    with (
        patch("yoto_lib.lyrics_source_wizard.httpx.get", return_value=index_response),
        patch("yoto_lib.lyrics_source_wizard._analyze_index_page", return_value=index_analysis),
        patch("yoto_lib.lyrics_source_wizard._run_js", return_value=[]),
    ):
...
def test_run_wizard_lyrics_js_no_content():
    ...
    with (
        ...
        patch("yoto_lib.lyrics_source_wizard._analyze_index_page", return_value=index_analysis),
        patch("yoto_lib.lyrics_source_wizard._analyze_lyrics_page", return_value=lyrics_analysis),
        patch("yoto_lib.lyrics_source_wizard._run_js", side_effect=run_js_results),
    ):
